System.register(['dropzone'], function (_export) {
  'use strict';
  ...
  function dropzone(FileService, $cacheFactory) {
    var dropOverlay = document.getElementById('filedrop-overlay');
    var dropzoneEl = undefined;
      ...
      $scope.$on('$viewContentLoaded', function () {
        if (!dropzoneEl) {
          (function () {
            ...
            var addFile = function addFile(newFile) {
